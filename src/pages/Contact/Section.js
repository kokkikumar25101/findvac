                            ...
                            <Col md={4}>
                                <Card className="contact-detail text-center border-0">
                                    ...
                                    <div className="content mt-3">
                                        ...
                                        <p className="text-muted">Call us incase on any queries</p>
                                        <Link to="#" onClick={this.callNumber} className="text-primary">+91 123456890</Link>
                                    </div>  
                                    </CardBody>
                                </Card>
                            </Col>
                            ...
                            <Col md={4} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <CardBody className="p-0">
                                    ...
                                    <div className="content mt-3">
                                        ...
                                        <p className="text-muted">Send queries to the below email.</p>
                                        <Link to="#" onClick={this.sendMail} className="text-primary">contact@findvac.org</Link>
                                    </div>
                                    </CardBody>
                                </Card>
                            ...
                            <Col md={4} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <CardBody className="p-0">
                                    ...
                                    <div className="content mt-3">
                                        ...
                                        <p className="text-muted">93, <br />Thayyur, Old Mahabalipuram Rd, <br />Kelambakkam, <br />Tamil Nadu 603103</p>
                                        <Link to="#" className="video-play-icon h6 text-primary">View on Google map</Link>
                                    </div>
                                    </CardBody>
                                </Card>
                            </Col>
                        ...
                        <Row>
                            <Col xs={12} className="p-0">
                                <Card className="map border-0">
                                    <CardBody className="p-0">
                                    <iframe title="myFrame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3891.013644705348!2d80.2157295!3d12.7776257!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5250ec678262f3%3A0x1e45625bac343863!2sAlliance%20Humming%20Gardens!5e0!3m2!1sen!2sin!4v1616238332089!5m2!1sen!2sin" style={{ border: "0" }} className="rounded" allowFullScreen></iframe>
