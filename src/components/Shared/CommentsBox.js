                                                    ...
                                                    <div className="d-flex justify-content-between">
                                                        <div className="media align-items-center">
                                                            ...
                                                            <div className="commentor-detail">
                                                                <h6 className="mb-0"><Link to="#" className="text-dark media-heading">{comment.name}</Link></h6>
                                                                            ...
                                                                            comment.replies.map((reply, key) =>
                                                                                <li key={key} className="mt-4">
                                                                                    <div className="d-flex justify-content-between">
                                                                                        <div className="media align-items-center">
                                                                                            <Link className="pr-3" to="#">
                                                                                                <img src={reply.image} className="img-fluid avatar avatar-md-sm rounded-circle shadow" alt="comment"/>
                                                                                            </Link>
                                                                                            <div className="commentor-detail">
                                                                                                <h6 className="mb-0"><Link to="#" className="text-dark media-heading">{reply.name}</Link></h6>
